...
function themerex_ready_actions() {
	...
	jQuery('.scroll_to_top,.scroll_to_tope,.scroll_to_topi,.scroll_to_top3').click(function(e) {
		"use strict";
...
function themerex_scroll_actionsj() {
	"use strict";

	var scroll_offset = jQuery(window).scrollTop();
	var scroll_to_top_button = jQuery('.scroll_to_top,.scroll_to_tope,.scroll_to_topi,.scroll_to_top3');
